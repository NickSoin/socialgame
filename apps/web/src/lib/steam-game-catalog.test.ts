...
describe('toSteamUpcomingGame', () => {
  it('maps a dated wishlist catalog row into a forecast card', () => {
    const game = toSteamUpcomingGame({
      steam_app_id: 388860,
      name: 'Judas',
      image_url: 'https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/388860/header.jpg',
  ...
  it('keeps unknown release dates open as TBA', () => {
    const game = toSteamUpcomingGame({
      ...
      image_url: 'https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/17750/header.jpg',
      release_date: null,
      release_label: 'TBA',
    });

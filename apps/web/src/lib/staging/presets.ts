...
export const SIMULATION_PRESETS: readonly SimulationPreset[] = [
  oneGame('market_predicts_correctly', 'Market predicts correctly', 'A calibrated crowd converges near all three outcomes.', 80, baseValues(18_000, 4_200, 29.99), { follower: 0.45, expert: 0.35, random: 0.2 }),
